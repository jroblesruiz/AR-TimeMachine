...
char myssid[] = "RGNET";              // your network SSID (name)
char mypass[] = "apocrifa11manana";   // your network password


//Credentials for Google GeoLocation API...
const char* Host = "www.googleapis.com";
String thisPage = "/geolocation/v1/geolocate?key=";
String key = "AIzaSyBJzrVYpKhUmy_bh-z_dp2GnR0vI3pI9kc";
...
void loop() {
  ...
  Serial.println("http://maps.google.com/maps?q=" + String(latitude, 6) + "," + String(longitude, 6));
